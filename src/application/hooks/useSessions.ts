...
export const useSessions = (): UseSessionsReturn => {
    ...
    const loadSessions = useCallback(async (page: number = 1, size: number = 20) => {
    ...
    const loadSessionsByEvent = useCallback(async (eventId: number, page: number = 1, size: number = 20) => {
        setLocalLoading(true);
        try {
    ...
    const createSession = useCallback(async (sessionData: ISessionCreateDto) => {
        setLocalLoading(true);
        try {
    ...
    const updateSession = useCallback(async (sessionId: number, sessionData: ISessionUpdateDto) => {
        setLocalLoading(true);
        try {
    ...
    const createEventSession = useCallback(async (eventId: number, sessionData: Omit<ISessionCreateDto, 'event_id'>) => {
        setLocalLoading(true);
        try {
