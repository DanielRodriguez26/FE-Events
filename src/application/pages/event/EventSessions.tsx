            ...
            const mockSessions: Session[] = [
                {
                    ...
                    description: "Aprende los fundamentos de React y cómo crear componentes reutilizables.",
                    start_time: "2024-03-15T09:00:00",
                    end_time: "2024-03-15T10:30:00",
                ...
                },
                {
                    ...
                    description: "Profundiza en el uso de hooks personalizados y patrones avanzados.",
                    start_time: "2024-03-15T11:00:00",
                    end_time: "2024-03-15T12:30:00",
                ...
                },
                {
                    ...
                    description: "Mejores prácticas para testing de componentes y aplicaciones React.",
                    start_time: "2024-03-15T14:00:00",
                    end_time: "2024-03-15T15:30:00",
                    speaker: "Ana Martínez",
                    room: "Sala C",
                    capacity: 35,
                    registered_attendees: 22
                },
                {
                    id: 4,
                    title: "Performance y Optimización",
                    description: "Técnicas para optimizar el rendimiento de aplicaciones React.",
                    start_time: "2024-03-15T16:00:00",
                    end_time: "2024-03-15T17:30:00",
                    speaker: "Luis Pérez",
                    room: "Sala A",
                    capacity: 45,
                    registered_attendees: 38
                }
            ];
                ...
                <div className="mb-8">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">
                            Sesiones - {eventById?.title || 'Evento'}
                        </h1>
                        <p className="text-gray-600">
                            {eventById?.description || 'Descripción del evento'}
                        </p>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        ...
                                        disabled={session.registered_attendees >= session.capacity}
                                    ...
                                    >
                                        {session.registered_attendees >= session.capacity ? 'Lleno' : 'Inscribirse'}
                                    </button>
                                </div>
                            </div>
                        </div>
